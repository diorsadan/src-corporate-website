  ...
  return (
    <svg width="120" height="60" viewBox="0 0 120 60" fill="none" xmlns="http://www.w3.org/2000/svg">
      ...
      <g>
        ...
        {/* Black inner outline for emphasis */}
      ...
      {/* SRC text - bold emerald green with black outline */}
      <g>
