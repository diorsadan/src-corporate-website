                ...
                <div key={pin.label} className={pin.containerClass}>
                  <div className="relative">
                    <MapPin
                      ...
                      style={pin.animationDelay ? { animationDelay: pin.animationDelay } : undefined}
                    />
              ...
              {zone.imageFirstOnLarge ? (
                <>
                  ...
                  <div className="order-1 lg:order-2">
                    ...
                    <p className="text-lg text-gray-700 mb-6 leading-relaxed">{zone.description}</p>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            {propertyInfrastructureFeatures.map((item) => {
              ...
              return (
                <div key={item.label} className="text-center p-6 bg-gray-50 rounded-lg hover:shadow-lg transition-shadow">
                  <div
      ...
      <section className="py-20 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">{propertyGallerySection.subtitle}</p>
          </div>

          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {images.gallery.propertyShowcase.map((image, index) => (
              <div key={image} className="rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
                <ImageWithFallback
                  src={image}
