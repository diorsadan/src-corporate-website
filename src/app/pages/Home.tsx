  ...
  return (
    <div className="w-full">
      ...
      <section className="relative min-h-screen lg:h-screen flex items-center justify-center overflow-hidden pt-20 lg:pt-0">
        ...
        {/* Hero Content */}
        <div className="relative z-10 max-w-6xl mx-auto w-full px-4 sm:px-6 lg:px-8 text-center py-16 lg:py-0">
          ...
          <Link
            to={homeHero.ctaPath}
            className="inline-flex items-center gap-3 bg-[#059669] hover:bg-[#047857] text-white px-8 sm:px-10 py-3 lg:py-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-1 border border-emerald-500/30 font-semibold text-base lg:text-lg whitespace-nowrap"
          >
            {homeHero.ctaLabel}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-8 sm:gap-10 lg:gap-12">
            {homeStats.map((stat) => {
              ...
              return (
                <div key={stat.label} className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6 group text-center sm:text-left">
      ...
      <section className="py-20 sm:py-24 lg:py-28 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="text-center mb-12 sm:mb-16 lg:mb-20 space-y-4 lg:space-y-5">
            <h2
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 lg:gap-8">
            {featuredEconomicZones.map((zone, index) => (
              <div
                key={index}
                className="group bg-white rounded-xl overflow-hidden border border-gray-100 hover:border-gray-200 transition-all duration-300 hover:shadow-md hover:-translate-y-1 cursor-pointer"
              >
      ...
      <section className="py-20 sm:py-24 lg:py-28 bg-gradient-to-b from-gray-50 to-white border-t border-gray-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          {/* Section Header */}
          <div className="text-center mb-12 sm:mb-16 lg:mb-20 space-y-3 lg:space-y-4">
            <h2
              className="text-3xl sm:text-4xl lg:text-5xl text-gray-900 tracking-tight"
              style={{ fontWeight: 800, letterSpacing: "-0.02em" }}
            >
          ...
          <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 sm:gap-6 lg:gap-8 items-center">
            {homePartners.map((partner, index) => (
              <div
                key={partner.name}
                className="flex items-center justify-center p-4 sm:p-6 lg:p-8 rounded-lg lg:rounded-xl border border-gray-200 bg-white hover:bg-gray-50 transition-all duration-300 group cursor-pointer hover:border-gray-300 hover:shadow-sm h-24 sm:h-28 lg:h-32"
              >
                {/* Logo or Text - Premium Presentation */}
                <div
                  className={`${partnerTextClass[partner.display]} transition-all duration-300 group-hover:scale-105 text-center line-clamp-2`}
                >
                  {partner.name}
                </div>
              </div>
      ...
      <section className="py-20 sm:py-24 lg:py-28 bg-gradient-to-br from-[#059669] to-[#047857] text-white relative overflow-hidden">
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 py-12 lg:py-0">
          <h2
          ...
          <Link
            to="/leasing"
            className="inline-flex items-center gap-3 bg-white text-[#059669] hover:bg-gray-50 px-8 sm:px-10 py-3 lg:py-4 rounded-lg transition-all duration-300 shadow-lg hover:shadow-2xl hover:-translate-y-1 font-semibold whitespace-nowrap"
          >
